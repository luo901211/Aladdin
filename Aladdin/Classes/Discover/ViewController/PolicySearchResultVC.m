...
@interface PolicySearchResultVC ()

@property (nonatomic, strong) PolicyListViewModel *viewModel;

@end

@implementation PolicySearchResultVC
...
- (void)loadDataWithType:(WQFetchDataType)type
{
    ...
    [self.viewModel loadDataListWithKeyword:self.keyword pageIndex:pageIndex success:^(BOOL noMoreData) {
        @strongify(self)
